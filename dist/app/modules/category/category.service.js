...
const getSingleCategory = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const booksOfThisCategory = yield prisma_1.prisma.book.findMany({
        where: {
            genre: result === null || result === void 0 ? void 0 : result.title,
        },
    });
    const data = Object.assign(Object.assign({}, result), { books: booksOfThisCategory !== null && booksOfThisCategory !== void 0 ? booksOfThisCategory : [] });
    return data;
});
